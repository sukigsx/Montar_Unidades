...
echo -e""
echo -e "${verde} Diseñado por sukigsx / Contactooooooooooooooooooooooooooooooooooooooooooooo:  sukisx.mbsistemas@gmail.com${borra_colores}"
...
case $opcion in 
    ...
    4)  #Resetear toda la configuracion
        ...
        clear
        echo -e ""
        echo -e "${azul} Se borra fichero de configuracion.${borra_colores}"
        sleep 1
    ...
    7)  #Montar las unidades al inicio del sistema. con crontab
        ...
        then
            ...
            echo "sleep 30" >> /home/$(whoami)/.config/montar_unidades_automatico
...
for paquete in net-tools figlet smbclient wmctrl git nano cifs-utils nmap #ponemos el fostware a instalar separado por espacios
do
